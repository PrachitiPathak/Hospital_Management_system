...
class Patient(EntityManager):
    ...
    def add_arrival_info(self):
        ...
        query = """
            INSERT INTO Patient_arrival_Info (Pat_ID, Arrival_Date, Symptoms)
            VALUES (%s, %s, %s)
        """
...
class Appointment(BaseEntity):
    def schedule_appointment(self):
        ...
        self.execute_query("SELECT Patient_ID, Patient_Contacts FROM Patient_details")
        patients = self.fetch_all()
        for p in patients:
            print(f"ID: {p[0]}, Contact: {p[1]}")
        ...
        stts_input = input("Enter Appointment Status: ")
        ...
        query = """
            ...
            VALUES (%s, %s, %s, %s)
        """
        self.execute_query(query, (patient_id, doctor_id, datetime_combined, stts_input))
